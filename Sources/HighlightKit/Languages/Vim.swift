...
extension LanguageCatalog {
    /// Vim Script. Port of highlight.js `languages/vim.js`.
    public static let vim = LanguageDescriptor(name: "vim") {
        LanguageDefinition(
            name: "vim",
            root: Mode(
                keywords: Keywords(
                    ...
                    [
                        ...
                        "built_in": Keywords.Group(stringLiteral: // built in func
                ...
                contains: [
                    ...
                    // A double quote can start either a string or a line
                    // comment. Strings are ended before the end of a line by
                    // another double quote and can contain escaped
                    // double-quotes and post-escaped line breaks.
                    //
                    // Also, any double quote at the beginning of a line is a
                    // comment but we don't handle that properly at the
                    // moment: any double quote inside will turn them into a
                    // string. Handling it properly will require a smarter
                    // parser.
                    Mode(
                        scope: "string",
                        begin: #""(\\"|\n\\|[^"\n])*""#
