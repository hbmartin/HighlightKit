...
extension LanguageCatalog {
    /// CMake. Port of highlight.js `languages/cmake.js`.
    public static let cmake = LanguageDescriptor(name: "cmake", aliases: ["cmake.in"]) {
        LanguageDefinition(
            name: "cmake",
            aliases: ["cmake.in"],
            caseInsensitive: true,
            root: Mode(
                keywords: Keywords(keyword: Keywords.Group(stringLiteral:
                    // scripting commands
